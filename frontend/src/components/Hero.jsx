  ...
  return (
    <section className="relative overflow-hidden bg-gradient-to-b from-[#f8fbff] via-[#f0f7ff] to-[#eef4ff]">
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        />
        {/* Soft light overlay to keep contrast readable */}
        ...
        <div className="grid lg:grid-cols-2 gap-12 xl:gap-16 items-center">
          ...
          <div className={`transition-all duration-1000 ${mounted ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"}`}>
            <div className="inline-flex items-center gap-3 px-4 py-2 rounded-full bg-[#e6f0ff] border border-[#1fb6ff]/20 mb-8 backdrop-blur-sm">
              <span className="text-sm text-[#0f1b3d]/65 font-medium">
            ...
            <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-4 mt-10">
              <Button
                size="lg"
                className="w-full sm:w-auto bg-gradient-to-r from-[#1fb6ff] to-[#6366f1] hover:from-[#17a9ef] hover:to-[#5b57f0] text-[#0f1b3d] border-0 rounded-full px-8 py-6 text-base font-semibold shadow-xl shadow-[#1fb6ff]/25 hover:shadow-[#1fb6ff]/40 transition-all duration-300 hover:-translate-y-0.5"
              >
                Start Free Trial
            ...
            <div className="mt-14 flex flex-col sm:flex-row items-start sm:items-center gap-5 sm:gap-4">
              <div className="flex -space-x-2.5">
                {[
                  "from-[#1fb6ff] to-[#6366f1]",
                  "from-[#6366f1] to-[#a78bfa]",
                  "from-[#a78bfa] to-[#f472b6]",
                  "from-[#f472b6] to-[#1fb6ff]",
                ].map((gradient, i) => (
                  <div
                    key={i}
                    className={`w-9 h-9 rounded-full border-2 border-[#f0f7ff] bg-gradient-to-br ${gradient} shadow-lg`}
                  />
                ))}
              </div>
              <div>
                <div className="flex items-center gap-0.5 mb-0.5">
                  {[...Array(5)].map((_, i) => (
                    <svg key={i} className="w-3.5 h-3.5 text-[#f472b6] fill-[#f472b6]" viewBox="0 0 20 20">
                      <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z" />
                    </svg>
                  ))}
                </div>
                <p className="text-sm text-[#0f1b3d]/40">
                  Trusted by <span className="text-[#0f1b3d]/70 font-semibold">10,000+</span> marketers
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="relative">
              ...
              <div className="hero-dashboard relative glass rounded-2xl p-6 shadow-2xl">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                  {stats.map((stat, i) => (
                    ...
                    >
                      ...
                      <p className="text-xl font-bold text-[#0f1b3d]">{stat.value}</p>
                ...
                <div className="hero-stat-block mt-4 flex items-center justify-between bg-[#e6f0ff] rounded-xl p-4 border border-[#1fb6ff]/35">
                  <div>
                    ...
                    <p className="text-2xl font-bold text-[#0f1b3d] mt-0.5">49.9%</p>
                  </div>
              ...
              <div className="absolute -top-4 -right-4 glass rounded-xl p-3 shadow-lg shadow-[#1fb6ff]/20">
                <div className="flex items-center gap-2.5">
                  ...
                  <div>
                    <p className="text-[10px] text-[#0f1b3d]/40 font-medium">Revenue</p>
                    <p className="text-sm font-bold text-[#0f1b3d]">+23.5%</p>
                  </div>
                </div>
              </div>
              ...
              <div className="absolute -bottom-3 -left-3 glass rounded-xl p-3 shadow-lg shadow-[#1fb6ff]/20">
                <div className="flex items-center gap-2.5">
                  ...
                  <div>
                    <p className="text-[10px] text-[#0f1b3d]/40 font-medium">New Leads</p>
                    <p className="text-sm font-bold text-[#0f1b3d]">+127</p>
                  </div>
                </div>
              </div>
            </div>
